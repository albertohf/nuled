  ...
  return (
    <div>
      ...
      <div className="relative -mt-12 lg:-mt-24">
        <svg transform="rotate(180)" className="wave-botton" viewBox="0 0 1439 147" version="1.1">
        ...
        <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                <p className="w-full text-gray-600 text-xs md:text-sm px-6">
                  <img src="/undraw_Navigation_re_wxx4.svg" width="auto" height="auto" />
                </p>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                <p className="w-full text-gray-600 text-xs md:text-sm px-6">
                  <img src="/undraw_All_the_data_re_hh4w.svg" width="auto" height="auto" />
                </p>
                <div className="w-full font-bold text-xl text-gray-800 px-6">
                  Lorem ipsum dolor sit amet.
              </div>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                <p className="w-full text-gray-600 text-xs md:text-sm px-6">
                  <img src="/undraw_monitor_iqpq.svg" width="auto" height="auto" />
                </p>
                <div className="w-full font-bold text-xl text-gray-800 px-6">
                  Lorem ipsum dolor sit amet.
              </div>
